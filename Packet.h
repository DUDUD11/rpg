...
enum class  PACKET_ID : UINT16
{
	...
	MONSTER_MOVEMENT_REQUEST = 405,
	MONSTER_MOVEMENT_BROADCAST = 406,
...
struct MONSTER_MOVEMENT_REQUEST_PACKET : public MONSTER_SPAWN_BROADCAST_PACKET
{
	VECTOR3 TARGET_ROTATION;
	INT16 TARGET_ANIMATION_X;
	INT16 TARGET_ANIMATION_Y;
...
struct MONSTER_MOVEMENT_BROADCAST : public MONSTER_SPAWN_BROADCAST_PACKET
{
	VECTOR3 TARGET_ROTATION;
	INT16 TARGET_ANIMATION_X;
	INT16 TARGET_ANIMATION_Y;
